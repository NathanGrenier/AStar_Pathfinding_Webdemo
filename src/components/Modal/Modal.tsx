        ...
        <div className="modal">
          ...
          <div className="modal-content">
            <div className="container">
                <div className="header"><h2>Controlls:</h2></div>
                <div className="item">                
                ...
                <div className="item">
                    <div className="bold"><span className="material-symbols-outlined">Shift</span> + Left Mouse Drag:</div>
                    <div> Place walls</div>
                </div>
                <div className="item">
                    <div className="bold"><span className="material-symbols-outlined">Shift</span> + Right Mouse Drag:</div>
                    <div> Remove walls</div>
                </div>
            </div>
            <div className="container">
                <div className="header"><h2>Legend:</h2></div>
                <div className="item">                
